...
legend("topleft", legend= c("Green Party ", "Liberal Party", "Conservative Party", "ndp", "Bloc Québécois", "People's Party", "Another party (please specify)", "Don't know/ Prefer not to answer"), fill = c("#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7"))
```
